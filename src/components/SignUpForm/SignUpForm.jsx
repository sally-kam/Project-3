  ...
  return (
    <div className="justify-center items-center w-full max-w-xs">
      <div className="form-container p-3">
        ...
        <div className="text-left bg-white relative z-0 w-full mb-6 group">
          <input type="email" name="email" value={state.email} onChange={handleChange} className="text-left bg-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-red-900 appearance-none dark:text-white dark:border-gray-900 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " required />
        ...
        <div className="text-left bg-white relative z-0 w-full mb-6 group">
          <input type="password" name="password" value={state.password} onChange={handleChange} className="text-left bg-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-red-900 appearance-none dark:text-white dark:border-gray-900 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " required />
        ...
        <div className="text-left bg-white relative z-0 w-full mb-6 group">
          <input type="password" name="confirm" value={state.confirm} onChange={handleChange} className="text-left bg-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-red-900 appearance-none dark:text-white dark:border-gray-900 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " required />
